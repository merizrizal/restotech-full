...
$jscript = '
    ...
    $("#stockmovement-item_id").on("select2:select", function(e) {
        ...
        $.ajax({
            dataType: "json",
            cache: false,
            url: "' . Url::toRoute(['item-sku/get-sku-item']) . '?id=" + $("#stockmovement-item_id").select2("data")[0].id,
    ...
    $jscript .= '
        ...
        $("#stockmovement-storage_from").on("select2:select", function(e) {
            ...
            $.ajax({
                dataType: "json",
                cache: false,
                url: "' . Url::toRoute(['storage-rack/get-storage-rack']) . '?id=" + $("#stockmovement-storage_from").select2("data")[0].id,
                success: function(response) {
