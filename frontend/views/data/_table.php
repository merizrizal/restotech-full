...
<div class="row">
    <div class="col-sm-12 mb">
        <?= Html::a('<i class="fa fa-arrow-circle-left"></i> Back', Yii::$app->urlManager->createUrl([Yii::$app->params['posModule']['full'] . 'data/table-category', 'isOpened' => $isOpened]), ['id' => 'back-table', 'class' => 'mb']) ?>
    </div>
</div>
